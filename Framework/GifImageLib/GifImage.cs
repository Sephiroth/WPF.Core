...
namespace GifImageLib
{
    ...
    public class GifImage : System.Windows.Controls.UserControl
    {
        ...
        private void CreateFromSourceString(string source)
        {
            ...
            if (string.Equals(source.Trim(), ".GIF") || ForceGifAnim)
            {
                ...
                else
                {
                    ...
                    if (string.Equals(leftPart, "http://") || string.Equals(leftPart, "ftp://") || string.Equals(leftPart, "ftp://"))
                    {
        ...
        private void GetGifStreamFromPack(Uri uri)
        {
            try
            {
                ...
                if (!uri.IsAbsoluteUri)
                {
                    ...
                    streamInfo = streamInfo ?? Application.GetResourceStream(uri);
                }
                else
                {
